        ...
        <div className="pb-16 mx-[40px] overflow-hidden bg-white ">
                    ...
                    {hover ?
                        <Link to={`/project/${id}`}
                            ...
                            <svg width="29" height="30" viewBox="0 0 29 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_286_316" x1="5.05161" y1="3.69607" x2="26.7927" y2="18.7078" gradientUnits="userSpaceOnUse">
                            ...
                            ver caso
                            <svg className="mt-1 animate-bounce-x" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M11.0837 0.911057L17.4477 7.27502C17.8382 7.66554 17.8382 8.29871 17.4477 8.68923L11.0837 15.0532C10.6932 15.4437 10.06 15.4437 9.6695 15.0532C9.27898 14.6627 9.27898 14.0295 9.6695 13.639L14.3264 8.98213H0.129883V6.98213H14.3264L9.6695 2.32527C9.27898 1.93475 9.27898 1.30158 9.6695 0.911057C10.06 0.520533 10.6932 0.520533 11.0837 0.911057Z" fill="white" />
                            </svg>
                        </Link>
                        : ""
                    }
            ...
            <div className="flex flex-col gap-12 md:flex-row">
                ...
                <div className="md:flex hidden relative text-[25px] flex-col md:py-6 flex-grow max-w-[400px] font-bold tracking-tight text-right text-indigo flex-start shrink-0">
                    {project.badge !== null ? <img className="w-20 h-20 mb-[10px] ml-auto md:-mt-[64px] md:mr-[14px] -top-10 right-10" alt="cover" src={project.badge} /> : ''}
                    <ReactMarkdown className={`home_highlight leading-tighter tracking-tighter ${project.badge !== null ? "text-[25px]" : ""}`} children={project.highlights} />
                </div>
            </div>
        </div>
    );

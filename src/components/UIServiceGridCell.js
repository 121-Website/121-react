export default function UIServiceGridCell({ service, id, color }) {
    ...
    return (
        <div className={`flex flex-col break-inside-avoid flex-grow gap-0 px-10 py-6 lg:py-16 lg:px-10 sm:px-5 sm:py-3 md:px-10 md:py-6 text-indigo ${service.order}`}
